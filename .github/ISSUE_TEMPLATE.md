<!--
0. This repository is created by a programmer for programmers. It's not a finished product for the end user. If you are new in programming or not a programmer at all, then you are not welcome here.
